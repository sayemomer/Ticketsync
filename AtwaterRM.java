...
import Assignment3.RemoteImplementation1;
...
import static Assignment3.RemoteImplementation1.movieDatabase;

public class AtwaterRM {
    public static void main(String[] args) throws IOException {

        RemoteImplementation1 obj = new RemoteImplementation1("ATWATER");
        DatagramSocket asocket = new DatagramSocket(6012);
        ...
        RemoteImplementation1 sr = new RemoteImplementation1("ATWATER");
        Runnable task = () -> {
            try {
                UDPServer(sr);
            } catch (IOException e) {
        ...
        while (true) {
            ...
            if(functions.equalsIgnoreCase("addMovieSlots")){
               ...
               response =  obj.getBookingSchedules(customerID);
                ...
                String numOfTickets = parts[9];
                //unsure about this
                String new_movieID = parts[7];

                String new_movieName = parts[8];
...
//                System.out.println("old_movieName: " + old_movieName);
                ...
                int numberOfTickets = Integer.parseInt(numOfTickets);
                response = obj.exchangeTickets(customerID,movieID,new_movieID,new_movieName,numberOfTickets);
...
//                    response = "Available" + " " + new_movieName + " " + new_movieID;
//                } else {
//                    response = "NotAvailable" + " " + new_movieName + " " + new_movieID;
//                }
//
//                response = obj.cancelMovieTickets(customerID, movieID, movieName, numberOfTickets);
            }
    ...
    public static void UDPServer(RemoteImplementation1 sr) throws IOException {
        try {
            ...
            DatagramSocket ds = new DatagramSocket(6122);
