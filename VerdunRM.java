...
public class VerdunRM {
    public static void main(String[] args) throws IOException {


        RemoteImplementation1 obj = new RemoteImplementation1("Verdun");
        Runnable task = () -> {
            try {
                UDPServer(obj);
            } catch (IOException e) {
        ...
        DatagramSocket RMsocket = new DatagramSocket(6014);
        byte[] buffer = new byte[1024];
        DatagramPacket apacket = new DatagramPacket(buffer, buffer.length);
        System.out.println("Verdun server is  ready and Running");


        

        while (true) {
            RMsocket.receive(apacket);
            ...
            if(functions.equalsIgnoreCase("addMovieSlots")){
                ...
                String numOfTickets = parts[9];
                //unsure about this
                String new_movieID = parts[4];

                String new_movieName = parts[5];
...
//                System.out.println("old_movieName: " + old_movieName);
    ...
    public static void UDPServer(RemoteImplementation1 sr) throws IOException {
        try {
            ...
            DatagramSocket ds = new DatagramSocket(6123);
