...
import static Booking.BookingImpl.dataInfo;

public class Outremont {
    public static void main(String[] args) throws IOException {

        BookingImpl obj = new BookingImpl("OUTREMONT");
        DatagramSocket asocket = new DatagramSocket(7779);
        ...
        BookingImpl sr = new BookingImpl("OUTREMONT");
        Runnable task = () -> {
            try {
                UDPServer(sr);
            } catch (IOException e) {
        ...
        while (true) {
            ...
            if(method_to_invoke_from_BookingImpl.equalsIgnoreCase("addMovieSlots")){
                ...
                response = obj.bookMovieTickets(customerID,movieName, movieID, number_of_tickets);
            }
