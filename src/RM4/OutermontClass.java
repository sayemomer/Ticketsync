...
public class OutermontClass implements RemoteInterface{
private static final long serialVersionUID = 1L;
  
public static HashMap<String, HashMap<String, Movie>> movieSlots;
	private HashMap<String, Booking> bookings;
	private String theatrePrefix = "out";
    ...
    public OutermontClass() throws RemoteException {
		super();
		 ...
		 movie1.put("OUTM220323",new Movie("OUTM220323","Avatar",25));
		 movie2.put("OUTA220323",new Movie("OUTA220323","Avengers",25));
		 movie3.put("OUTE220323",new Movie("OUTE220323","Titanic",25));
