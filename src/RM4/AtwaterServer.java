...
public class AtwaterServer {
	...
	AtwaterClass obj = new AtwaterClass();
    DatagramSocket asocket = new DatagramSocket(6982);
    ...
    AtwaterClass sr = new AtwaterClass();
    Runnable task = () -> {
        receive(sr);
    };
...
//
//		System.out.println("Atwater Server is Started");
//		Runnable task = () -> {
//		
...
//		thread.start();
	...
	private static void receive(AtwaterClass obj) {
		...
		try {
			...
			System.out.println("Atwater UDP Server 8888 Started............");
			while (true) {
