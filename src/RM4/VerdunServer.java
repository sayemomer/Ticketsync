...
public class VerdunServer {
	...
	VerdunClass obj = new VerdunClass();
    DatagramSocket asocket = new DatagramSocket(6962);
    ...
    VerdunClass sr = new VerdunClass();
    Runnable task = () -> {
        receive(sr);
    };
...
//
//		System.out.println("Verdun Server is Started");
//		Runnable task = () -> {
//		
...
//		thread.start();
	...
	private static void receive(VerdunClass obj) {
		...
		try {
			...
			System.out.println("Verdun UDP Server 7777 Started............");
			while (true) {
