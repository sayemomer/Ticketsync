...
public class AtwaterClass implements RemoteInterface{
private static final long serialVersionUID = 1L;
  
    public static HashMap<String, HashMap<String, Movie>> movieSlots;
	private HashMap<String, Booking> bookings;
	private String theatrePrefix = "atw";
    ...
    public AtwaterClass() throws Exception {
		super();
		 ...
		 movie1.put("ATWM220323",new Movie("ATWM220323","Avatar",25));
		 movie2.put("ATWA220323",new Movie("ATWA220323","Avengers",25));
		 movie3.put("ATWE220323",new Movie("ATWE220323","Titanic",25));
